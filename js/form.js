...
div.innerHTML = "<div class="autocomplete-item-title">" + ev.name + "</div><div class="autocomplete-item-sub">" + ev.key + " • " + (ev.city || "Location Unknown") + "</div>";
...
disp.innerHTML = "<div style="font-size:1.15rem;margin-bottom:4px;color:#000;">✓ " + team.name + "</div><div style="font-size:0.8rem;color:#333;font-weight:600;">📍 " + team.location + "</div>";
...
function getMultiValues(name, otherId) {
...
const name = TEAM_LIST[t] ? TEAM_LIST[t].name : "Unknown";
